...
@section('content')
    <div class="container mx-auto px-6 py-8">
        <h1 class="text-3xl font-semibold text-gray-800 mb-6">Tambah Kategori</h1>

        <form action="{{ route('admin.addKategori') }}" method="POST" class="bg-white p-6 rounded-lg shadow-lg">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nama_kategori" name="nama_kategori"
                       ...
                       required value="{{ old('nama_kategori') }}" placeholder="Masukkan Nama Kategori">
